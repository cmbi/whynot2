...
public class CopyOfCommenter {
	...
	public static void main(String[] args) throws Exception {
		CopyOfCommenter commenter = new CopyOfCommenter();
		commenter.commentAll();
		commenter.uncommentAll();
	}

	public CopyOfCommenter() {
	...
	public boolean comment(String path) throws Exception {
		...
		try {
			...
			if (succes)
				Logger.getLogger(CopyOfCommenter.class).info(path + ": Succes");
			else
				Logger.getLogger(CopyOfCommenter.class).error(path + ": Failure");
		}
		return succes;
	}

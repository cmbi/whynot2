-- Two databanks
insert into databank (id, crawltype, filelink, name, parent_id, reference, regex) values (1, 'LINE', '#${PDBID}', 'MMCIF', 1, 'https://pdb.org', '[a-zA-Z0-9]{4}');
insert into databank (id, crawltype, filelink, name, parent_id, reference, regex) values (2, 'LINE', '#${PDBID}', 'PDB', 1, 'https://pdb.org', '[a-zA-Z0-9]{4}');
insert into databank (id, crawltype, filelink, name, parent_id, reference, regex) values (3, 'LINE', '#${PDBID}', 'DSSP', 2, 'https://dssp.org', '[a-zA-Z0-9]{4}');
